      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            ...
            <td class="text-left"><a href="<?php echo $invoice['vendor']; ?>"><?php echo $invoice['name']; ?></a></td>
            ...
            <td class="text-right"><a href="<?php echo $invoice['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a> 
                

                <a href="<?php echo $invoice['view']; ?>" title="<?php echo $button_view; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
...
function filter() {
	url = 'index.php?load=billing/vendor_invoice&token=<?php echo $token; ?>';
...
$(document).ready(function () {
	...
	$('.status').change(function () {
		...
		$.ajax({
			url: 'index.php?load=billing/vendor_invoice/update&token=<?php echo $token; ?>',
			type: 'post',

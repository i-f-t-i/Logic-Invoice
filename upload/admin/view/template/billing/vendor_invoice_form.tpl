    ...
    <form method="post" action="<?php echo $action; ?>" class="form-horizontal" id="form-invoice">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
            ...
            <div class="col-sm-10">
             <input type="text" name="name" value="<?php echo $name; ?>" id="input-name" class="form-control" placeholder="<?php echo $entry_name; ?>" autofocus />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="form-group">
            <label class="col-sm-2 control-label" for="input-invoiceno"><?php echo $entry_invoiceno; ?></label>
            <div class="col-sm-10">
              <input type="text" name="invoiceno" value="<?php echo $invoiceno; ?>" id="input-invoiceno" class="form-control" placeholder="<?php echo $entry_invoiceno; ?>"  />
            </div>
          </div>
        ...
        <div class="tab-pane" id="tab-payment-detail">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-payment-address"><?php echo $entry_payment_address; ?></label>
            <div class="col-sm-10">
              <input type="text" name="payment_address" value="<?php echo $payment_address; ?>" id="input-payment-address" class="form-control" placeholder="<?php echo $entry_payment_address; ?>" />
            </div>
          </div>

            <div class="form-group">
            <label class="required col-sm-2 control-label" for="input-payment-email"><?php echo $entry_payment_email; ?></label>
            <div class="col-sm-10">
              <input type="text" name="payment_email" value="<?php echo $payment_email; ?>" id="input-payment_email" class="form-control" placeholder="<?php echo $entry_payment_email; ?>" required />
            </div>
          </div>

             <div class="form-group">
            <label class="required col-sm-2 control-label" for="input-payment-phone"><?php echo $entry_payment_phone; ?></label>
            <div class="col-sm-10">
              <input type="text" name="payment_phone" value="<?php echo $payment_phone; ?>" id="input-payment_phone" class="form-control" placeholder="<?php echo $entry_payment_phone; ?>" required />
            </div>
          </div>  
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="payment_code" id="input-payment-code" class="form-control">
                  ...
                  <?php $payments = array("Bank","Debit Card", "Credit Card", "Other", "Not paid yet"); ?>

                  <?php foreach ($payments as $payment) { ?>
                <option value="<?php echo $payment; ?>"<?php echo $payment == $payment_code ? ' selected="selected"' : ''; ?>><?php echo $payment; ?></option>
                <?php } ?>
...
$(document).ready(function () {
	...
	$('#input-name').autocomplete({
		'source': function (request, response) {
			$.ajax({
				url: 'index.php?load=billing/vendor/autocomplete&token=<?php echo $token; ?>&filter_name=' + encodeURIComponent(request),
				dataType: 'json',
				success: function (json) {
					response($.map(json, function (item) {
						return {
							label: item['name'] + ' (' + item['email'] + ')' + ' (' + item['address'] + ')' + ' (' + item['phone'] + ')',
	...
	$('#button-forward-step-1').click(function () {
		$.ajax({
			url: 'index.php?load=billing/vendor_invoice/validate_step_1&token=<?php echo $token; ?>',
			...
			success: function (json) {
				if (json['success']) {
					...
					if (json['name']) {
						$('#tab-general input[name=\'name\']').after('<span class="text-danger">' + json['name'] + '</span>');
					}

					if (json['address']) {
						$('#tab-general input[name=\'address\']').after('<span class="text-danger">' + json['address'] + '</span>');
					}
	...
	$('#button-forward-step-3').click(function () {
		$.ajax({
			url: 'index.php?load=billing/vendor_invoice/validate_step_3&token=<?php echo $token; ?>',
			...
			success: function (json) {
				if (json['success']) {
                    ...
                    if (json['input-payment-description']) {
						$('#tab-payment-method select[name=\'input-payment-description\']').after('<span class="text-danger">' + json['input-payment-description'] + '</span>');
					}
	...
	$('#button-forward-step-4').click(function () {
		$.ajax({
			url: 'index.php?load=billing/vendor_invoice/validate_step_4&token=<?php echo $token; ?>',
			type: 'post',
